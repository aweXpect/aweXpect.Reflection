...
namespace aweXpect.Reflection.Api.Tests;
...
public sealed class ApiApprovalTests
{
	...
	public async Task VerifyPublicApiForAweXpectReflection(string framework)
	{
		const string assemblyName = "aweXpect.Reflection";
