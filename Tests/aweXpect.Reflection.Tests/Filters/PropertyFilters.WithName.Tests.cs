		...
		public sealed class Tests
		{
			...
			public async Task ShouldFilterForTypesWithName()
			{
				...
				await That(properties.GetDescription())
					.IsEqualTo("properties with name equal to \"SomePropertyToVerifyTheNameOfI…\" in assembly")
					.AsPrefix();
			}
			...
			public async Task ShouldSupportAsPrefix()
			{
				...
				await That(properties).HasSingle().Which.IsEqualTo(ExpectedPropertyInfo());
				await That(properties.GetDescription())
					.IsEqualTo("properties with name starting with \"SomePropertyToVerifyTheNameOf\" in assembly")
					.AsPrefix();
			}
			...
			public async Task ShouldSupportAsRegex()
			{
				...
				await That(properties).HasSingle().Which.IsEqualTo(ExpectedPropertyInfo());
				await That(properties.GetDescription())
					.IsEqualTo("properties with name matching regex \"[a-zA-Z]*PropertyToVerifyTheNa…\" in assembly")
					.AsPrefix();
			}
			...
			public async Task ShouldSupportAsSuffix()
			{
				...
				await That(properties).HasSingle().Which.IsEqualTo(ExpectedPropertyInfo());
				await That(properties.GetDescription())
					.IsEqualTo("properties with name ending with \"PropertyToVerifyTheNameOfIt\" in assembly").AsPrefix();
			}
			...
			public async Task ShouldSupportAsWildcard()
			{
				...
				await That(properties).HasSingle().Which.IsEqualTo(ExpectedPropertyInfo());
				await That(properties.GetDescription())
					.IsEqualTo("properties with name matching \"*PropertyToVerifyTheNameOf*\" in assembly").AsPrefix();
			}
			...
			public async Task ShouldSupportIgnoringCase()
			{
				...
				await That(properties.GetDescription())
					.IsEqualTo(
						"properties with name equal to \"somepropertytoverifythenameofi…\" ignoring case in assembly")
					.AsPrefix();
			}
			...
			public async Task ShouldSupportIgnoringLeadingWhiteSpace()
			{
				...
				await That(properties.GetDescription())
					.IsEqualTo(
						"properties with name equal to \"\\t SomePropertyToVerifyTheNameO…\" ignoring leading white-space in assembly")
					.AsPrefix();
			}
			...
			public async Task ShouldSupportIgnoringTrailingWhiteSpace()
			{
				...
				await That(properties.GetDescription())
					.IsEqualTo(
						"properties with name equal to \"SomePropertyToVerifyTheNameOfI…\" ignoring trailing white-space in assembly")
					.AsPrefix();
			}
			...
			public async Task ShouldSupportUsingCustomComparer()
			{
				...
				await That(properties.GetDescription())
					.IsEqualTo(
						"properties with name equal to \"SOmEPropertyTOVErIfyThENAmEofi…\" using IgnoreCaseForVocalsComparer in assembly")
					.AsPrefix();
			}
		}
	}
