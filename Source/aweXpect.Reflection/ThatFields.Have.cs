...
public static partial class ThatFields
{
	...
	/// </remarks>
	public static HaveAttributeResult<FieldInfo?> Have<TAttribute>(
	...
	private sealed class HaveAttributeConstraint(
		...
		AttributeFilterOptions<FieldInfo?> attributeFilterOptions)
		: ConstraintResult.WithNotNullValue<IEnumerable<FieldInfo?>>(it, grammars),
			IValueConstraint<IEnumerable<FieldInfo?>>
	{
		...
		protected override void AppendNormalResult(StringBuilder stringBuilder, string? indentation = null)
		{
			...
			Formatter.Format(stringBuilder, Actual?.Where(fieldInfo => !attributeFilterOptions.Matches(fieldInfo)),
