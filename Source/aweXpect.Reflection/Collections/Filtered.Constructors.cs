...
public static partial class Filtered
{
	...
	public class Constructors : Filtered<ConstructorInfo, Constructors>, IDescribableSubject
	{
		...
		/// <summary>
		///     A Container for a filterable collection of <see cref="ConstructorInfo" />,
		///     that also allows specifying string equality options.
		/// </summary>
		public class StringEqualityResult : Constructors
		{
			private readonly StringEqualityOptions _options;

			internal StringEqualityResult(Constructors inner, StringEqualityOptions options) : base(inner)
			{
				_options = options;
			}
		...
		public class StringEqualityResultType : StringEqualityResult
		{
			...
			internal StringEqualityResultType(Constructors inner, StringEqualityOptions options) : base(inner, options)
			{
				_options = options;
			}
