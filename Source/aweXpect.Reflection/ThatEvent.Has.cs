...
{
	/// <summary>
	///     Verifies that the <see cref="EventInfo" /> has attribute of type <typeparamref name="TAttribute" />.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	///     Verifies that the <see cref="EventInfo" /> has attribute of type <typeparamref name="TAttribute" /> that
